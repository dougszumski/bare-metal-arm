...
//
__attribute__ ((section (".cfmconfig"))) const uint8_t _cfm[0x10] = { 0xFF, /* NV_BACKKEY3: KEY=0xFF */
...
static void init_clocks(void) {
	...
	SIM_SOPT2 =
			(SIM_SOPT2 & ~(SIM_SOPT2_TPMSRC(0x02))) | SIM_SOPT2_TPMSRC(0x01);

	/* PORTA_PCR18: ISF=0,MUX=0 */
	/* PORTA_PCR19: ISF=0,MUX=0 */PORTA_PCR18 &= ~((PORT_PCR_ISF_MASK | PORT_PCR_MUX(0x07)));
	...
	/* MCG_C1: CLKS=2,FRDIV=3,IREFS=0,IRCLKEN=0,IREFSTEN=0 */MCG_C1 =
			(MCG_C1_CLKS(0x02) | MCG_C1_FRDIV(0x03));
	/* MCG_C4: DMX32=0,DRST_DRS=0 */MCG_C4 &= ~((MCG_C4_DMX32_MASK
			| MCG_C4_DRST_DRS(0x03)));
	/* MCG_C5: ??=0,PLLCLKEN0=0,PLLSTEN0=0,PRDIV0=1 */MCG_C5 =
			MCG_C5_PRDIV0(0x01);
	/* MCG_C6: LOLIE0=0,PLLS=0,CME0=0,VDIV0=0 */MCG_C6 = 0;
...
void __attribute__((naked)) _HardFault_Handler(uint32_t lr, void *psp,
		void *msp) {
